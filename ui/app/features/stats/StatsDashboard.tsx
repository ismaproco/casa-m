...
const text = {
  es: {
    ...
    subtitle:
      "Compara el segmento filtrado con todo Bogotá y abre cualquier corte en el mapa.",
    segment: "Segmento actual",
    allBogota: "Todo Bogotá",
    listings: "Anuncios",
  ...
  en: {
    title: "Market pulse",
    subtitle:
      "Compare the filtered segment with all Bogotá and open any slice on the map.",
    segment: "Current segment",
    allBogota: "All Bogotá",
    listings: "Listings",
